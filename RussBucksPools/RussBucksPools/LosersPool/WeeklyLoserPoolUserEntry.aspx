<%@ Page Title="Enter Picks" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="WeeklyLoserPoolUserEntry.aspx.vb" Inherits="RussBucksPools.WeeklyLoserPoolUserEntry" %>
  ...
  <div class="container2 clearfix">
    ...
    <asp:Table ID="GameTable1" runat="server" GridLines="None" CssClass="GameTable gT1" CellPadding="-1" CellSpacing="-1" >
        ...
        <asp:TableRow Height="15px">
            <asp:TableCell ID="HomePick1" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game1HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home1" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick1" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game1AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away1" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick2" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game2HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home2" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick2" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game2AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away2" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick3" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game3HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home3" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick3" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game3AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away3" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick4" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game4HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home4" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick4" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game4AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away4" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
    ...
    <asp:Table ID ="GameTable2" runat="server"  GridLines="None" CssClass="GameTable gT2" CellPadding="-1" CellSpacing="-1" >
        ...
        <asp:TableRow Height="15px">
            <asp:TableCell ID="HomePick5" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game5HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home5" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick5" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game5AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away5" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick6" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game6HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home6" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick6" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game6AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away6" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick7" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game7HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home7" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick7" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game7AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away7" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick8" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game8HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home8" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick8" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game8AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away8" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
    ...
    <asp:Table ID ="GameTable3" runat="server"  GridLines="None" CssClass="GameTable gT3" CellPadding="-1" CellSpacing="-1" >
        ...
        <asp:TableRow Height="15px">
            <asp:TableCell ID="HomePick9" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game9HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home9" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick9" style="text-align:center" Width="15px"  ><asp:RadioButton ID="Game9AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away9" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick10" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game10HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home10" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick10" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game10AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away10" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick11" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game11HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home11" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick11" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game11AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away11" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick12" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game12HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home12" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick12" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game12AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away12" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
    ...
    <asp:Table ID ="GameTable4" runat="server"  GridLines="None" CssClass="GameTable gT4" CellPadding="-1" CellSpacing="-1" >
        ...
        <asp:TableHeaderRow Height="15px">
            ...
            <asp:TableHeaderCell Id="GameNumber16" ColumnSpan="2" style="text-align:center" Width="30px" ></asp:TableHeaderCell>
        ...
        <asp:TableHeaderRow Height="15px">
            ...
            <asp:TableHeaderCell Id="GameNumber16Status" ColumnSpan="2" style="text-align:center" Width="30px" ></asp:TableHeaderCell>
        ...
        <asp:TableHeaderRow Height="60px">
            ...
            <asp:TableHeaderCell ID="HomeTeam16Image" style="text-align:center" Width="15px" ><asp:Image ID="HomeTeam16Image1" runat="server" /></asp:TableHeaderCell>
            <asp:TableHeaderCell ID="AwayTeam16Image" style="text-align:center" Width="15px" ><asp:Image ID="AwayTeam16Image1" runat="server" /></asp:TableHeaderCell>
        ...
        <asp:TableHeaderRow Height="15px">
            ...
            <asp:TableHeaderCell ID="HomeTeam16Icon" style="text-align:center" Width="15px" ><asp:Image ID="HomeTeam16Icon1" runat="server" /></asp:TableHeaderCell>
            <asp:TableHeaderCell ID="AwayTeam16Icon" style="text-align:center" Width="15px" ><asp:Image ID="AwayTeam16Icon1" runat="server" /></asp:TableHeaderCell>

        </asp:TableHeaderRow>
        <asp:TableRow Height="15px">
            <asp:TableCell ID="HomePick13" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game13HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home13" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick13" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game13AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away13" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick14" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game14HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home14" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick14" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game14AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away14" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick15" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game15HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home15" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick15" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game15AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away15" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="HomePick16" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game16HomeRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Home16" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
            <asp:TableCell ID="AwayPick16" style="text-align:center" Width="15px" ><asp:RadioButton ID="Game16AwayRadio" Visible="false" runat="server" GroupName="PPick" /><asp:ImageButton ID="Away16" runat="server" ImageUrl="~/Models/RadioButtonImages/Unchecked.png" CssClass="radioButton" OnClick="ImageButton_Click" Visible="false"/></asp:TableCell>
