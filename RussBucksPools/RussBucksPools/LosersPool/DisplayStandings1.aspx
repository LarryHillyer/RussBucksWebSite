<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="DisplayStandings1.aspx.vb" Inherits="RussBucksPools.DisplayStandings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <h2 id="Test1"><%:CStr(ViewState("dayNumber"))%></h2>
    <br />
