<%@ Page Title="Weekly Results" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="DisplayStandings.aspx.vb" Inherits="RussBucksPools.DisplayStandings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 id ="Test1"><%:Page.Title + "  - " + CStr(Session("poolAlias")) + " - " + CStr(Session("TimePeriod"))%></h2><br />
